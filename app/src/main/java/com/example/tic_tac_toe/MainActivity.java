...
public class MainActivity extends AppCompatActivity {
    ...
    int []gameState={-1,-1,-1,-1,-1,-1,-1,-1,-1};
      public void load(View view) {
          ...
          for (int i = 0; i < winingState.length; i++) {
              if (gameState[winingState[i][0]] == gameState[winingState[i][1]] && gameState[winingState[i][1]] == gameState[winingState[i][2]] && gameState[winingState[i][0]] > -1) {
